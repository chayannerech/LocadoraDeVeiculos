...
using System.Text;
namespace LocadoraDeVeiculos.Dominio.Compartilhado.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string Validation(this string textoEscolhido)
            => textoEscolhido.ToLower().Trim().RemoveDiacritics();
